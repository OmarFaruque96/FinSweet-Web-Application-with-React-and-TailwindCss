function Banner(){
    return(
        <div className="w-full py-16 md:py-28 px-4 md:px-0">   
                ...
                <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-16 align-center">
                    <div>
                        ...
                        <form method="post" action="">
                            <input type="email" placeholder="Enter Your Email Id" className="bg-off-white inter py-3 px-8 mb-4 w-full md:w-auto" />
                            <input type="submit" value="Subscribe" className="bgBlue text-white inter font-semibold py-3 px-8 mb-4 w-full md:w-auto" />
                        </form>
                    </div>
                    <div>
